...
class MainFragment : Fragment() {
    ...
    private fun initializeAds() {
        ...
        adViewModel = ViewModelProviders.of(this, adViewModelFactory).get(AdViewModel::class.java)
    ...
    private fun observeAdViewModel(data: LiveData<List<RFPInstreamInfoModel>>) {
        data.observe(this, Observer { ads ->
            Timber.d("Ads loaded")
            ads?.forEach { ad ->
